...
import static org.boomslang.ui.preferences.PreferenceConstants.P_GENERATOR_SWITCH;
...
public class BuilderConfigurationBlock extends OptionsConfigurationBlock {
	...
	@Inject FeatureBuilderConfigurationExtension ext;
	...
	protected void createOutputSectionItems(Composite composite, OutputConfiguration outputConfiguration) {
		...
		String[] values = ext.allGeneratorExtensions().values().toArray(new String[]{});
		String[] valueLabels = ext.allGeneratorExtensions().keySet().toArray(new String[]{});
		addComboBox(composite, "Use generator:", P_GENERATOR_SWITCH, 0, values, valueLabels);
	}
